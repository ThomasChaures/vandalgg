  ...
  methods: {
    ...
    async handleSubmit() {
      if (
        ...
        try {
          await editarChat(this.$route.params.id, this.post.content, this.post.blockCode, true);
      ...
      <div v-if="blockCodeFlag" class="animate__animated animate__fadeIn">
        ...
        >
          ...
          >
            ...
            <span class="ml-2 text-gray-400 text-sm">{{ post.lenguaje }}.dev</span>
          </div>
